...
namespace Core.Migrations
{
    ...
    [Migration("20240911153344_addedQuantityColumnAndNavigationproperty")]
    partial class addedQuantityColumnAndNavigationproperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.ProductSpecs", b =>
                {
                    b.HasOne("Core.Entities.Product", "Product")
                        .WithOne("ProductSpecs")
                        .HasForeignKey("Core.Entities.ProductSpecs", "productId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
